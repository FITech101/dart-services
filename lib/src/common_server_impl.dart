...
const Duration _standardExpiration = Duration(minutes: 30);
...
class CommonServerImpl {
  ...
  Future<void> _setCache(String query, String result) => _cache.set(query, result, expiration: _standardExpiration);
}
